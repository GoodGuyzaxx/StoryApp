...
class MainViewModelTest {
    ...
    fun `when Get Story Should Not Null and Return Data`() = runTest {
        ...
        val actualStory: PagingData<ListStoryItem> =
            mainViewModel.getStory("token").getOrAwaitValue()
